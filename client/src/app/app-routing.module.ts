...
import { CcvvEditComponent} from './pages/ccvv-edit/ccvv-edit.component';
...
const routes: Routes = [
    ...
    { path: 'ccvvs/:id',  loadChildren: './pages/ccvv-edit/ccvv-edit.module#CcvvEditModule' , canActivate: [AuthGuard] },
